...
public class Juego extends InterfaceJuego {
	...
	Juego() {
		...
		lava = new Lava(480,680,0.5); // Ejemplo de posición inicial para la lava y velocidad de movimiento
...
//		/*DIBUJA LOS DISPAROS DEL JUGADOR*/
		...
		this.lava.moverse();
        this.lava.dibujarse(this.entorno);
	}
